...
// Import utlity functions - unfortunately they can't be line wrapped :(
import {documentHasElement, retrieveProperty, deleteChildren, appendElement, findSubstrings, randomElement, removeElement} from'./script.js';
...
window.removeUserFavorites = removeUserFavorites;
window.processNewFavorite = processNewFavorite;
